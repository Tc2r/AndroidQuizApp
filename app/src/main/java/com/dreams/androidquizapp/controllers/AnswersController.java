...
public class AnswersController
{
  ...
  public void getAnswers(Fragment fragment)
  {
    ...
    //    AnswersServiceJsonGitImpl answersServiceJsonGit = new AnswersServiceJsonGitImpl(this);
  ...
  private void loadAnswers()
  {
    ...
    answer1.setAnswer("It will perform the inter connection between activities and the data " + "passing mechanism.");
    answer1.setDetails("An Intent is connected to either the external world of application or internal world of " +
                       "application, Such as, opening a pdf is an intent and connect to the web browser.etc.");
    ...
    answer2.setDetails(
        ...
        "are compressed to a single file.");
    ...
    answer3.setDetails(
        "Android Explicit intent specifies the component to be invoked from " + "activity. We can call another " +
