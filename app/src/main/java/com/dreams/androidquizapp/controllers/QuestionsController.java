...
public class QuestionsController
{
  ...
  private void loadQuestions()
  {
    ...
    Question question1 = new Question.Builder(1, "multi", "What is Android?",
        ...
        "and some key applications. The " + "application executes within its own process and its own " +
        "instance of Dalvik Virtual Machine.").shortAns("A stack of software for mobile devices.").build();
    ...
    Question question2 = new Question.Builder(2, "multi", "What is a Service?",
        "Android is a stack of software for mobile devices which includes an " + "Operating System, middleware " +
        "and some key applications. The " + "application executes within its own process and its own " +
        "instance of Dalvik Virtual Machine.A component that runs in " + "the background to perform long " +
        "term running operations, " + "Services continue while app is destroyed.")
    ...
    Question question3 = new Question.Builder(3, "multi", "What is the APK format?",
        "The Android packaging key is compressed with classes,UI's, supportive " + "assets and manifest.All files" +
    ...
    Question question5 = new Question.Builder(5, "multi", "What is an android manifest file?",
        ...
        "system, information the system must have before it can run any" + " of the app's code.").shortAns(
        " It is a resource file which contains all the details needed by the " + "android" +
        " system about the application.").build();
